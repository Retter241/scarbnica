    ...
    <section id="change-get" style="margin-top: 5%;opacity: 1;">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="item-wrapper" style="min-height: 293px;
    width: 795px;
    margin-bottom: 25px;
    padding-left: 21px;">
                        ...
                        <div class="block-wrapper" style="color: #FFF;">
                            <div class="item-image"
                                 style="margin-top: 25px;margin-bottom: 30px;float: left;margin-right: 25px;margin-left:10px;display: inline-block;background: red;">
<!--                                <img src="template/img/item.jpg" alt="" style="    width: 160px;height: 175px;">-->
    ...
    color: #FFF;
    font-size: 20px;
    text-align: left;"><h3><a href="<?=$contentItem['product_id']?>" style="text-decoration: none; color: #fff">Название: <?=$contentItem['product_name']?></a></h3>
                            </div>
    ...
    color: #FFF;
    font-size: 20px;
    text-align: left;;">Автор: <a href="<?=$contentItem['user_id']?>" style="text-decoration: none; color: #fff"><?=$contentItem['user_name'] . ' ' . $contentItem['user_lastname']?></a>
                            </div>
    ...
    color: #FFF;
    font-size: 20px;
    text-align: left;"><p><?=$contentItem['short_description']?></p>
                            </div>
